...
export const Titlebar = () => {
    ...
    useEffect(() => {
        ...
        const updateMaximizedStatus = () => {
            setIsMaximized(currentWindow.isMaximized());
        };

        updateMaximizedStatus();
        currentWindow.on('maximize', updateMaximizedStatus);
        currentWindow.on('unmaximize', updateMaximizedStatus);

        return () => {
            currentWindow.removeListener('maximize', updateMaximizedStatus);
            currentWindow.removeListener('unmaximize', updateMaximizedStatus);
        };
    }, []);
