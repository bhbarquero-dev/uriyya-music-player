    ...
    <div className="window-controls windows">
      ...
      >
        <svg width="11" height="1" viewBox="0 0 11 1" aria-hidden="true">
          <path
            d="M11,0.5 C11,0.776142375 10.7761424,1 10.5,1 L0.5,1 C0.223857625,1 0,0.776142375 0,0.5 C0,0.223857625 0.223857625,0 0.5,0 L10.5,0 C10.7761424,0 11,0.223857625 11,0.5 Z"
            fill="currentColor"
          />
        </svg>
      </button>
      ...
      >
        {isMaximized ? (
          ...
          <svg width="11" height="11" viewBox="0 0 11 11" aria-hidden="true">
            <path
              d="M11,0.5 L11,10.5 C11,10.7761424 10.7761424,11 10.5,11 L0.5,11 C0.223857625,11 0,10.7761424 0,10.5 L0,0.5 C0,0.223857625 0.223857625,0 0.5,0 L10.5,0 C10.7761424,0 11,0.223857625 11,0.5 Z M10,1 L1,1 L1,10 L10,10 L10,1 Z"
              fill="currentColor"
            />
          </svg>
        )}
